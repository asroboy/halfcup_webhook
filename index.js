...
function firstEntity(nlp, name) {
    ...
    console.log('nlp.entities[' + name + ']', nlp.entities.get(name));
    console.log('nlp.entities[' + name + '][0]', nlp.entities.get(name)[0]);
    return nlp && nlp.entities && nlp.entities.get(name) && nlp.entities.get(name)[0];
}
